...
This declares a function named getRandomShow. Functions are reusable blocks of code that can be called whenever needed.
...
First call: getRandomShow() might return "Show 2".
Second call: getRandomShow() might return "Show 1".
Third call: getRandomShow() might return "Show 3".
